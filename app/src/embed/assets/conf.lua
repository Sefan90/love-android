function love.conf(t)
    ...
    t.window.title = "FaB Counter"         -- The window title (string)
    t.window.icon = nil                 -- Filepath to an image to use as the window's icon (string)
    t.window.width = 480--512--480--320                -- The window width (number)
    t.window.height = 960--683--960--480               -- The window height (number)
